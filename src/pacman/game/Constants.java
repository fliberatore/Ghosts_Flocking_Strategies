...
public final class Constants
{
	...
	public static final float GHOST_REVERSAL=0f;//.0015f;		//probability of a global ghost reversal event	
	public static final int MAX_TIME=4000;//24000;					//maximum time a game can be played for
