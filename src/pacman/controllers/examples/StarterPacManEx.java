...
import pacman.controllers.examples.mixmax.ABCMixMax2;
 ...
 */
public class StarterPacManEx extends Controller<MOVE>
{	
	private static final int MIN_DISTANCE=20;	//if a ghost is this close, run away

	private ABCMixMax2 miniMax;
	
	public StarterPacManEx( int mixmaxdepth ) {
