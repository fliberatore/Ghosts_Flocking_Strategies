...
{	
	...
	public static void main(String[] args)
	{
		...
		/*
		//run multiple games in batch - good for testing.
		int numTrials = 30;
		exec.runExperiment(new pacman.controllers.examples.AggressiveGhosts(), numTrials);
		System.out.println();
		exec.runExperiment(new pacman.controllers.examples.Legacy(), numTrials);
		System.out.println();
		exec.runExperiment(new pacman.controllers.examples.Legacy2TheReckoning(), numTrials);
		System.out.println();
		exec.runExperiment(new pacman.controllers.examples.RandomGhosts(), numTrials);
		System.out.println();
		exec.runExperiment(new pacman.controllers.examples.StarterGhosts(), numTrials);
		*/
		...
		int delay=5;
		boolean visual=true;
		exec.runGame(new StarterPacMan(),new pacman.entries.ghosts.GhostSwarm(),visual,delay);
		*/	
		...
		boolean visual=true;
		//exec.runGameTimed(new HumanController(new KeyBoardInput()),new pacman.entries.ghosts.GhostSwarm(),visual);
		exec.runGameTimed(new TomPepelsPacMan(),new pacman.entries.ghosts.GhostSwarm(),visual);
		...
		exec.runGameTimedSpeedOptimised(new StarterPacMan(),new RandomGhosts(),fixedTime,visual);
		*/
     ...
     */
    public void runExperiment(Controller<EnumMap<GHOST,MOVE>> ghostController,int trials)
    {

    	Random rnd=new Random(0);
		Game game;
		Controller<MOVE> control;
		double sumX = 0.0, sumX2= 0.0 , mean, stDev, cv, ciMin, ciMax;
		...
		for(int i=0;i<trials;i++)
		{
			...
			control = new StarterPacMan();
			while(!game.gameOver())
			{
		        game.advanceGame(control.getMove(game.copy(),-1),
		...
		fitness += 1.0/ciMax;
		System.out.println(mean + "\t" + stDev + "\t" + cv + "\t" + ciMin + "\t" + ciMax);
		...
		System.out.println(1.0/fitness);
